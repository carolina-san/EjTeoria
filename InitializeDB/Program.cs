...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: dsm_teoríaGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("dsm_teoríaGenNHibernate", "nhibernateUser", "nhibernatePass");
